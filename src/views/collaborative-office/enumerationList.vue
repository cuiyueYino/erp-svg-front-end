		...
		<el-row>
			<el-col style="text-align: right;">
				<el-dropdown trigger="click" @command="showForm = true;showSave = true;disabledUpd = false">
					<el-button :disabled="showFigButton" type="success"   size="small"><i class="el-icon-plus"></i>新增</el-button>
				...
				<el-button :disabled="showFigUpd" @click="toUpd()" size="small" type="danger"  ><i class="el-icon-edit"></i>修改</el-button>
			</el-col>
		</el-row>
		<el-row :gutter="10">
			<el-col :span="6">
				...
				<el-card>
					<el-form v-if="showForm" size="mini" label-width="80px" :rules="rules" ref="ruleForm" :model="ruleForm" class="demo-form-inline">
						...
						<el-form-item style="text-align: center;" v-if="showSubmit">
							<el-button @click="toSave" type="success"   size="small"><i class="el-icon-edit"></i>提交</el-button>
						</el-form-item>
					</el-form>
				</el-card>
			</el-col>
