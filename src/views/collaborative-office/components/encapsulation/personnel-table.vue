		...
		<el-card class="box-card">
			<el-form style="margin-bottom: 10px;" ref="formInline" label-width="10px" :model="formInline" class="demo-form-inline">
				<el-row>
					...
					<el-col :span="10">
						<el-form-item>
							<el-button type="primary" icon='el-icon-search' size="medium" @click="selectList()">搜索</el-button>
							<el-button type="primary" icon='el-icon-refresh' size="medium" plain @click="$refs.formInline.resetFields();showFig == 1 ? clear2() : clear();">重置</el-button>
							<el-button v-if="showFig == 1" type="primary" icon='el-icon-menu' size="medium" plain @click="getAll('formInline')">全部</el-button>
							<el-button v-if="showFig == 1" type="success" icon='el-icon-circle-check' size="medium" plain @click="getConList()">已选中</el-button>
						</el-form-item>
					</el-col>
					<el-col v-if="showFig == 1" :span="8" style="text-align: right;">
						<el-form-item>
							...
							<el-button type="success" icon='el-icon-check' size="medium" @click="workItemAuthRole()">确定</el-button>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
