<template>
	<div>
		<div v-if="!showFigForm">
			...
			<el-card class="box-card">
				<el-form :disabled="showFigNum == 1" size="mini" label-width="80px" :inline="true" :rules="rules" ref="ruleForm" :model="ruleForm" class="demo-form-inline">
					<el-row>
						<el-col :span="6">
			...
			<el-dialog title="工作事项模板子表分类" top="1vh" :destroy-on-close="true" center :visible.sync="dialogVisibleChild" width="80%" v-if="dialogVisibleChild">
				...
				<div slot="footer" class="dialog-footer">
					<el-button type="success" icon='el-icon-check' size="small" @click="getSelectMainTableClassification">确定</el-button>
					<el-button type="warning" icon='el-icon-close' size="small" @click="dialogVisibleChild = false">取消</el-button>
				</div>
			</el-dialog>
			<!--弹出框-->
			<el-dialog title="工作事项模板主表" top="1vh" :destroy-on-close="true" center :visible.sync="dialogVisible" width="80%" v-if="dialogVisible">
				...
				<div slot="footer" class="dialog-footer">
					<el-button type="success" icon='el-icon-check' size="small" @click="getDialogVisible(true)">确定</el-button>
