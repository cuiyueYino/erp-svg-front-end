		...
		<el-card class="box-card">
			<el-row :gutter="24">
				...
				<el-col style="text-align: right;" :span="10">
					...
					<el-button icon="el-icon-delete" type="primary">生效</el-button>
					<el-button icon="el-icon-delete" type="danger">禁用</el-button>
					<el-button @click="$parent.toAdd('3')" icon="el-icon-delete" type="primary" plain>查看</el-button>
				</el-col>
			</el-row>
		</el-card>
		<el-card class="box-card">
