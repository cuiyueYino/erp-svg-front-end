      ...
      <el-row :gutter="24">
        <el-col :span="18">
          <el-form :inline="true" :model="form" ref="form" class="demo-form-inline">
            ...
            <el-form-item>
              <el-button type="primary" icon="el-icon-tickets" size="medium" plain @click="resetForm('form')">显示全部信息</el-button>
            </el-form-item>
          </el-form>
        </el-col>
        <el-col :span="6" style="text-align: right;">
          <el-button type="success" plain icon="el-icon-folder-add" size="medium" @click="add">新增</el-button>
          <el-button type="warning" plain icon="el-icon-document-copy" size="medium" @click="toEdit">编辑</el-button>
