    ...
    width="50%"
     :visible.sync="dialogFormVisible"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="success" icon='el-icon-copy-document' size="small" @click="addSubmit('form')" :disabled="isLook">保存</el-button>
    ...
    <!-- 部门/职位弹窗 -->
      ...
      :close-on-click-modal="false">
        <!-- 部门 -->
         ...
         <div slot="footer" class="dialog-footer">
            <el-button type='success' size="small" icon='el-icon-check' @click="addPeople()">确定</el-button>
