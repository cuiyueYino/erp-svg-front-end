        ...
        >
            ...
            <el-tab-pane label="基本信息" name="1">
                ...
                <el-form-item label="审核工作" :label-width="formLabelWidth" prop="work">
                    ...
                    <el-button type="success" icon='el-icon-folder-add'  size="medium" plain class="joinWorkBtn" @click="addJoinWork('新增审核业务')">新增审核</el-button>
                </el-form-item>
            ...
            <el-tab-pane label="参与者" name="3">
                ...
                <el-row :gutter="24" class="joinTableBox">
                    ...
                    <el-col :span="3" class="joinBtnBox">
                        <el-button type="success" size="medium" icon='el-icon-folder-add' plain @click="joinSearch('新增参与者')">新增</el-button>
                        <el-button type="danger" size="medium" icon='el-icon-delete' plain @click="deleteMsg('新增参与者')">删除</el-button>
                    </el-col>
                </el-row>
                <!-- Condition END-->
            </el-tab-pane>
            <el-tab-pane label="抄送" name="4">
                ...
                <el-row :gutter="24" class="joinTableBox">
                    ...
                    <el-col :span="3" class="joinBtnBox">
                        <el-button type="success" size="medium" icon='el-icon-folder-add' plain @click="joinSearch('新增抄送')">新增</el-button>
                        <el-button type="danger" size="medium" icon='el-icon-delete' plain @click="deleteMsg('新增抄送')">删除</el-button>
                    </el-col>
                </el-row>
                <!-- Condition END-->
            </el-tab-pane>
                ...
                <div v-show="showInfoCheck">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="6" :offset="18">
                            ...
                            <el-button type="primary" size="medium" icon='el-icon-search' plain @click="SearchWorkSearchTable('')">搜索</el-button>
                        </el-col>
                    </el-row>
                    <!-- 表格 -->
                    <dynamic-table
    ...
    methods: {
        ...
        gridDataAdd(){
            ...
            if (this.titleStr === "新增参与者") {
                ...
                if (this.baseActiveNameStr == "角色") {
                    if (this.roleReq.name) {
                        let FlagStr=this.DuplicateCheck(this.tableData,this.roleReq.name);
                        if(FlagStr === "true"){
                            let roleObj = {};
                    ...
                    if (this.UserListReq.fname) {
                        let FlagStr=this.DuplicateCheck(this.tableData,this.UserListReq.fname);
                        if(FlagStr === "true"){
                            let UroleObj = {};
                            UroleObj = this.UserListReq;
                            UroleObj.type = 3;
                    ...
                    if (this.serveReq.fname) {
                        let FlagStr=this.DuplicateCheck(this.tableData,this.serveReq.fname);
                        if(FlagStr === "true"){
                            let SroleObj = {};
                            SroleObj = this.serveReq;
                            SroleObj.type = 4;
                    ...
                    if (this.posLReq.fname) {
                        let FlagStr=this.DuplicateCheck(this.tableData,this.posLReq.fname);
                        if(FlagStr === "true"){
                            let ProleObj = {};
                            ProleObj = this.posLReq;
                            ProleObj.type = 6;
                    ...
                    if (this.baseTextarea) {
                        let FlagStr=this.DuplicateCheck(this.tableData,this.baseTextarea);
                        if(FlagStr === "true"){
                            let BroleObj = {};
                            BroleObj.type = 5;
                            BroleObj.typeName = "expression";
