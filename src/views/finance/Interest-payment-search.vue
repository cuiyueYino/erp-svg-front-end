...
export default {
    props: {
        rowIPSDataObj:Object,
        financingIPStype: Boolean
    },
    name: 'basetable',
    components: {
        DynamicTable,
    ...
    methods: {
        ...
        handleClose(){
            ...
            this.$emit('changeShow',this.rowIPSDataObj,false);
        },
        ...
        savefinanceValue(){
            ...
            if(selectOption.length >0){
                if(selectOption.length >1){
                    ...
                    //返回选中的父组件选中的row,并修某些改值
                    this.rowIPSDataObj.searchRowRPScode=selectOption[0].code;
                    this.rowIPSDataObj.searchRowRPSname=selectOption[0].name;
                    this.rowIPSDataObj.searchRowRPSId=selectOption[0].id;
                    this.$emit('changeShow',this.rowIPSDataObj,false);
    ...
    watch:{
        financingIPStype(oldVal,newVal){
            this.ShowFinancVisible=this.financingIPStype;
            let rowDataObj=this.rowIPSDataObj;
