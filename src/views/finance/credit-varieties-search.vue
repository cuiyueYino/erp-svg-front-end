...
export default {
    props: {
        rowCVSDataObj:Object,
        financingCVStype: Boolean
    },
    name: 'basetable',
    components: {
        DynamicTable,
    ...
    methods: {
        ...
        handleClose(){
            ...
            this.$emit('changeShow',this.rowCVSDataObj,false);
        },
        ...
        savefinanceValue(){
            ...
            if(selectOption.length >0){
                if(selectOption.length >1){
                    ...
                    //返回选中的父组件选中的row,并修某些改值
                    this.rowCVSDataObj.searchRowCVScode=selectOption[0].code;
                    this.rowCVSDataObj.searchRowCVScodename=selectOption[0].name;
                    this.rowCVSDataObj.searchRowCVScodeId=selectOption[0].id;
                    this.$emit('changeShow',this.rowCVSDataObj,false);
    ...
    watch:{
        financingCVStype(oldVal,newVal){
            this.ShowFinancVisible=this.financingCVStype;
            let rowDataObj=this.rowCVSDataObj;
