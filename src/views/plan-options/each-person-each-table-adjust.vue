    ...
    <div v-if="ShowFinancVisible" class="itemDivStyle">
        ...
        >
            ...
            <el-row>
             ...
             <el-row>
                <el-col :span="6">
                     <el-form-item label="新工作名称：">
                        <el-input v-model="formdata.completion" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12" :offset="2">
                    <el-form-item label="新工作标准：">
                        <el-input v-model="formdata.newWorkName" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="6">
                     <el-form-item label="新开始时间：">
                        <el-input v-model="formdata.newBeginDate" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12" :offset="2">
                    <el-form-item label="新完成时间：">
                        <el-input v-model="formdata.newEndDate" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    props: {
        rowEachPerEachTableAdjDataObj: String,
        rowEachPerEachTableAdjtype:Boolean,
    },
    components: {
        DynamicTable,
    },
    ...
    watch:{
        rowEachPerEachTableAdjtype(oldVal,newVal){
            this.ShowFinancVisible=this.rowEachPerEachTableAdjtype;
             let adjSelected = {};
            adjSelected.id = this.rowEachPerEachTableAdjDataObj;
            this.getAdjDetail(adjSelected);
        }
    }
}
</script>
