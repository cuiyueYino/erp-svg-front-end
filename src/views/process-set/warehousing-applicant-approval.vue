...
>>>>>>> d43089e27ff752b5dc65cb8209825a84e0622aeb
  ...
  watch: {
    rowWAAtype(oldVal, newVal) {
      ...
      let formDataA = {};
      formDataA.oid = finandata[0].foid;
      var detailFlag = finandata[0].classId;
