<template>
    <div>
        <div style="width:200px;height:40px;float:right;">
            <el-button style="margin-left:50px;magin-right:5px;" @click.prevent="addRow()" type="success" icon="el-icon-folder-add" size="small">新增</el-button>
            <el-button  @click.prevent="delRowData()" type="danger" icon="el-icon-delete" size="small">删除</el-button>
        </div>
        <div>
            <el-table
                :data="tableSData"
