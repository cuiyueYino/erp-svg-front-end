...
export default {
    props: {
        rowBCSDataObj:Object,
        financingBCStype: Boolean
    },
    name: 'basetable',
    components: {
        DynamicTable,
        ...
        savefinanceValue(){
            ...
            if(selectOption.length >0){
                if(selectOption.length >1){
                    ...
                    //返回选中的父组件选中的row,并修某些改值
                    this.rowBCSDataObj.searchRowBCScode=selectOption[0].code;
                    this.rowBCSDataObj.searchRowBCSname=selectOption[0].name;
                    this.rowBCSDataObj.searchRowBCSId=selectOption[0].id;
                    this.$emit('changeShow',this.rowBCSDataObj,false);
    ...
    watch:{
        financingBCStype(oldVal,newVal){
            this.ShowFinancVisible=this.financingBCStype;
            let rowDataObj=this.rowBCSDataObj;
