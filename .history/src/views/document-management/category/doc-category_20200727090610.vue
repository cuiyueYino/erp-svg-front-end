                    ...
                    <el-card class="box-card">
                        <el-row :gutter="24">
                            ...
                            <el-col :span="9" :offset="3">
                                ...
                                <el-button type="primary" icon="el-icon-notebook-2" plain @click="removeMainte">查看</el-button>
                            </el-col>
                        </el-row>
                    </el-card>
                </el-col>
        ...
        maketree(){
            ...
            this.$api.documentManagement.getDocumentCategoryOrgArch().then(response => {
                ...
                if (responsevalue) {
                    ...
                    this.terrAllMenuData = JSON.parse(returndata.data);
                    this.treeData = this.toTreeData(JSON.parse(returndata.data),"foid","fpid","fname","fcode");
